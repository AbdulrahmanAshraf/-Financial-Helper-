...
namespace grad_proj
{
    public partial class form_add_delete : Form
    {
        ...
        private void tb_ssn_TextChanged(object sender, EventArgs e)
        {

        }

        private void cb_add_pro_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lab_profision_Click(object sender, EventArgs e)
        {

        }

        private void lab_department_Click(object sender, EventArgs e)
        {

        }

        private void cb_add_dep_SelectedIndexChanged(object sender, EventArgs e)
        {
